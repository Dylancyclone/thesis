...
\todo[inline]{Should this be a section on it's own or collapse it like the previous chapter?}
...
\begin{enumerate}
  ...
  \item \textbf{Software Performance:} \emph{Can this solution be powerful enough to stream demanding applications to a client while remaining performant enough to be usable?}
\end{enumerate}
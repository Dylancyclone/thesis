...
While there are many applications in existence that allow a user to remotely control a computer from another location, few of them offer the \todo{Clarify power, since the issue isn't processing power}power required to stream high-performing applications to a remote device.

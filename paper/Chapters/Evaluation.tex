...
\begin{figure}[h]
  ...
  \chronograduation[event][dateselevation=0pt]{11}

  \chronoevent[date=false]{2}{Key is pressed on client}
  \chronoevent[date=false,markdepth=35pt]{6}{Key is received by host}
  \chronoevent[date=false]{8}{Key is pressed on host}

  \chronoperiode[textstyle=\raggedleft\colorbox{cyan!50}, color=cyan, startdate=false, bottomdepth=5pt, topheight=10pt, textdepth=-15pt,stopdate=false]{2}{6}{Network Latency}
  \chronoperiode[textstyle=\colorbox{green!50}, color=green, startdate=false, bottomdepth=5pt, topheight=10pt, textdepth=-15pt,stopdate=false]{6}{8}{Application Latency}
  \chronoperiode[textstyle=\colorbox{orange!50}, color=orange, startdate=false, bottomdepth=0pt, topheight=5pt, textdepth=-40pt,stopdate=false]{2}{8}{Total Latency}
...
\vspace{15mm} % Get the header of the block onto the next page. This can be removed if formatting changes
...
\subsection{AI Training}\label{subsec:RealWorldAI}
...
\subsection{Video Game Development}\label{subsec:RealWorldVideoGame}

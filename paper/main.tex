...
\thesistitle{Building a Mobile Device that Uses the Power of a Desktop Computer} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)
	...
	\textbf{SBC} & \textbf{S}ingle \textbf{B}aard \textbf{C}omputer\\
